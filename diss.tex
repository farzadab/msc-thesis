...
\title{Learning Locomotion: Symmetry and Torque Limit Considerations}
%\subtitle{If you want a subtitle}

\author{Farzad Abdolhosseini}
\previousdegree{B.Sc., Sharif University of Technology, 2017}
...
\examiningcommittee{Leonid Sigal, Computer Science}{Additional Examiner}
...
%% files
\hypersetup{
  pdftitle={Learning Locomotion: Symmetry and Torque Limit Considerations},
  pdfauthor={Farzad Abdolhosseini},
  pdfkeywords={Reinforcement Learning, Locomotion, Computer Graphics, Physics-based Animation, Invariance, Equivariance, Symmetry, Curriculum Learning}
}
