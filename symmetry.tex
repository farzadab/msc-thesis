...
The construction of the mirror functions for our environments (\Cref{sec:environments}) are further 
...
We measure the effectiveness for each symmetry enforcement methods on the metrics we defined in \Cref{sec:metrics}.  
...
The symmetry metrics results are summarized in \Cref{tab:actuation_si} and \Cref{tab:pp_msi}.  
